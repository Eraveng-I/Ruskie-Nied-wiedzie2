        ...
        if(WrogowieWZasieguRuchu.size()>0)   //czy są wrogowie w zasięgu ruchu?
        {
            ...
            if(WrogowieWZasieguRuchu.get(0).zdrowie<=0)
            {
                if(WrogowieWZasieguRuchu.get(0).rodzaj==1){
                    ...
                    Symulacja.TablicaPol[WrogowieWZasieguRuchu.get(0).aktualneWspY][WrogowieWZasieguRuchu.get(0).aktualneWspX].IloscZwlokLudzi++;
                    ...
                    Symulacja.TablicaPol[WrogowieWZasieguRuchu.get(0).aktualneWspY][WrogowieWZasieguRuchu.get(0).aktualneWspX].IloscZwlokNiedzwiedzi++;
